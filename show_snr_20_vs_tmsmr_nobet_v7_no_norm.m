...
figure_folder='FIGURE_FOLDERS'
base_proce_folder='PROCESSING_FOLDER'
load([base_proce_folder,'results.mat'])
...
snr_20Ch_masked=snr_20Ch_final.*mask;
snr_with_tms_only_brain=snr_with_tms_norm.*mask;

% For gain
snr_gain_20Ch=(snr_with_tms_only_brain./snr_20Ch_masked);
snr_gain_20Ch_smooth=imgaussfilt3(snr_gain_20Ch,1);
%% Crop the image to show more brain
crop_x=20;
crop_y=20;
% %
 ...
 saveas(h_1,[figure_folder,'/SNR_20Ch_v7_nonorm.tif']);
